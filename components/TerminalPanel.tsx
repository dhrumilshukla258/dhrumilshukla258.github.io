...
function processCommand(cmd: string, router: ReturnType<typeof useRouter>, personality: Personality): Line[] {
...
export function TerminalPanel() {
  ...
  const { terminalOpen, setTerminalOpen, addToast: menuAddToast } = useMenu();
