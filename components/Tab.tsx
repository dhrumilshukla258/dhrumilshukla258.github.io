...
const Tab = ({ icon, filename, path, dropIndicator, onClose, onDragStart, onDragOver, onDrop, onDragEnd }: TabProps) => {
  ...
  return (
    <div
      ref={ref}
      className={`${styles.tab} ${isActive ? styles.active : ''} ${dropIndicator ? styles.dropTarget : ''}`}
      draggable
